 ...
 */
?>
<?php if( 'none' != get_theme_mod('lovebond_lite_rat_first_section', 'none') ) {
	$the_query = new WP_Query( array( 'page_id' => get_theme_mod('lovebond_lite_rat_first_section') ) );
	if ( $the_query->have_posts() ) :
		while ( $the_query->have_posts() ) : $the_query->the_post(); ?>
		<section id="section1" class="front-sections skt-default-page"><div class="skt-page-overlay"></div>
			<!-- Container-->
			<div class="container post-wrap rpage_wrap">
				...
				<div class="animatedParent row section-heading-content">
					...
					<p class="animated growIn col-xs-12 col-sm-9 col-md-9"><?php echo esc_attr( get_theme_mod('lovebond_lite_rat_first_section_desc') ); ?></p>
				</div>
