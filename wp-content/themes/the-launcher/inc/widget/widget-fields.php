...
function the_launcher_widgets_show_widget_field($instance = '', $widget_field = '', $athm_field_value = '') {
    ...
    switch ($the_launcher_widgets_field_type) {
        ...
        case 'text' :?>
            <p>
                <label for="<?php echo $instance->get_field_id($the_launcher_widgets_name); ?>"><?php echo esc_attr($the_launcher_widgets_title); ?>:</label>
                <input class="widefat" id="<?php echo $instance->get_field_id($the_launcher_widgets_name); ?>" name="<?php echo $instance->get_field_name($the_launcher_widgets_name); ?>" type="text" value="<?php echo $athm_field_value; ?>" />
        ...
        case 'textarea' :
            ...
            <p>
                <label for="<?php echo $instance->get_field_id($the_launcher_widgets_name); ?>"><?php echo esc_attr($the_launcher_widgets_title); ?>:</label>
                <textarea class="widefat" rows="<?php echo $the_launcher_widgets_row; ?>" id="<?php echo $instance->get_field_id($the_launcher_widgets_name); ?>" name="<?php echo $instance->get_field_name($the_launcher_widgets_name); ?>"><?php echo $athm_field_value; ?></textarea>
            </p>
            <?php
            break;
        ...
        case 'checkbox' :
            ?>
            <p>
                <input id="<?php echo $instance->get_field_id($the_launcher_widgets_name); ?>" name="<?php echo $instance->get_field_name($the_launcher_widgets_name); ?>" type="checkbox" value="1" <?php checked('1', $athm_field_value); ?>/>
                <label for="<?php echo $instance->get_field_id($the_launcher_widgets_name); ?>"><?php echo esc_attr($the_launcher_widgets_title); ?></label>
        ...
        case 'radio' :
            ...
            <p>
                <?php
                echo esc_attr($the_launcher_widgets_title);
                echo '<br />';
                foreach ($the_launcher_widgets_field_options as $athm_option_name => $athm_option_title) {
                    ?>
                    <input id="<?php echo $instance->get_field_id($athm_option_name); ?>" name="<?php echo $instance->get_field_name($the_launcher_widgets_name); ?>" type="radio" value="<?php echo $athm_option_name; ?>" <?php checked($athm_option_name, $athm_field_value); ?> />
        ...
        case 'select' :
            ...
            <p>
                <label for="<?php echo $instance->get_field_id($the_launcher_widgets_name); ?>"><?php echo esc_attr($the_launcher_widgets_title); ?>:</label>
                <select name="<?php echo $instance->get_field_name($the_launcher_widgets_name); ?>" id="<?php echo $instance->get_field_id($the_launcher_widgets_name); ?>" class="widefat">
        ...
        case 'number' :
            ?>
            <p>
                <label for="<?php echo $instance->get_field_id($the_launcher_widgets_name); ?>"><?php echo esc_attr($the_launcher_widgets_title); ?>:</label><br />
                <input name="<?php echo $instance->get_field_name($the_launcher_widgets_name); ?>" type="number" step="1" min="1" id="<?php echo $instance->get_field_id($the_launcher_widgets_name); ?>" value="<?php echo $athm_field_value; ?>" class="small-text" />
        ...
        case 'selectpost' :
            ...
            <p>
                <label for="<?php echo $instance->get_field_id($the_launcher_widgets_name); ?>"><?php echo esc_attr($the_launcher_widgets_title); ?>:</label>
                <select name="<?php echo $instance->get_field_name($the_launcher_widgets_name); ?>" id="<?php echo $instance->get_field_id($the_launcher_widgets_name); ?>" class="widefat">
                    <?php foreach ($the_launcher_postlist as $the_launcher_single_post) { ?>
                        <option value="<?php echo $the_launcher_single_post['value']; ?>" id="<?php echo $instance->get_field_id($the_launcher_single_post['label']); ?>" <?php selected($the_launcher_single_post['value'], $athm_field_value); ?>><?php echo $the_launcher_single_post['label']; ?></option>
                    <?php } ?>
                </select>
        ...
        case 'upload' :
            ...
            $output = '';
            $id = $instance->get_field_id($the_launcher_widgets_name);
            $class = '';
            $int = '';
            $value = $athm_field_value;
            $name = $instance->get_field_name($the_launcher_widgets_name);
            ...
            $output .= '<label for="' . $instance->get_field_id($the_launcher_widgets_name) . '">' . $the_launcher_widgets_title . '</label><br/>';
            $output .= '<input id="' . $id . '" class="upload' . $class . '" type="text" name="' . $name . '" value="' . $value . '" placeholder="' . __('No file chosen', 'the-launcher') . '" />' . "\n";
            if (function_exists('wp_enqueue_media')) {
                //if (( $value == '')) {
                    $output .= '<input id="upload-' . $id . '" class="upload-button button" type="button" value="' . __('Upload', 'the-launcher') . '" />' . "\n";
                //} else {
                    //$output .= '<input id="remove-' . $id . '" class="remove-file button" type="button" value="' . __('Remove', 'the-launcher') . '" />' . "\n";
                //}
            } else {
                $output .= '<p><i>' . __('Upgrade your version of WordPress for full media support.', 'the-launcher') . '</i></p>';
            }

            $output .= '<div class="screenshot team-thumb" id="' . $id . '-image">' . "\n";

            if ($value != '') {
                $remove = '<a class="remove-image">'. __('Remove', 'the-launcher').'</a>';
                $attachment_id = attachment_url_to_postid($value);
                $image_array = wp_get_attachment_image_src($attachment_id, 'medium');
                $image = preg_match('/(^.*\.jpg|jpeg|png|gif|ico*)/i', $value);
                if ($image) {
                    $output .= '<img width="276px" height="141px" src="' . $image_array[0] . '" alt="" />' . $remove;
                } else {
                    $parts = explode("/", $value);
                    ...
                    $title = __('View File', 'the-launcher');
        ...
        case 'icon1' :
            ...
            <p>
                <label for="<?php echo $instance->get_field_id($the_launcher_widgets_name); ?>"><?php echo esc_attr($the_launcher_widgets_title); ?>:</label><br />
                <span class="icon-receiver1"><i class="<?php echo $athm_field_value; ?>"></i></span>
                <input class="hidden-icon-input1" name="<?php echo $instance->get_field_name($the_launcher_widgets_name); ?>" type="hidden" id="<?php echo $instance->get_field_id($the_launcher_widgets_name); ?>" value="<?php echo $athm_field_value; ?>" />
            ...
            <div id="ap-font-awesome-list1">
                <ul class="ap-font-group1">
            ...
            <p>
                ...
                <input class="hidden-icon-input" name="<?php echo $instance->get_field_name($the_launcher_widgets_name); ?>" type="hidden" id="<?php echo $instance->get_field_id($the_launcher_widgets_name); ?>" value="<?php echo $athm_field_value; ?>" />
